  ...
  return (
    <>
      <div className={hero_wrap}>
        <div className={hero_wrap1}>
          <p className={hero_head}>
            Healthy in side <span className="text-[#8382EB]">fresh</span> out
            side
          </p>
          ...
          <div className={hero_btn}>
            ...
            <button className={hero_btn_lm}>
              ...
              <div className={hero_btn_lm_text}>Learn more</div>
            </button>
          </div>
          <div className={hero_brand}>
            <p className={hero_brand_title}>Brands:</p>
            <div className={hero_brand_icon}>
              <div className="nike">
